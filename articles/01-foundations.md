...
Любую программу можно разложить на три вида сущностей: вычисления, действия и данные.
...
Вычисление покрывают юнит-тестом: подали вход, сравнили выход.
Действие — интеграционным: подняли окружение, проверили, что эффект случился.
...
Иначе при сборке `InstrumentSpec` их можно перепутать местами, и компилятор бы смолчал. Тот же принцип применяется и здесь: спецификация собирается из типизированных шагов.
