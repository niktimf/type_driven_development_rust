...
Иначе при сборке `InstrumentSpec` их легко перепутать местами, и компилятор смолчит.

Конструктор намеренно строгий, а не округляющий. Тихо подвинуть цену к ближайшему тику — значит изменить заявку за спиной у того, кто её выставляет: на лимитке это другая цена исполнения, живые деньги.
