...
Он работал в Jane Street — фирме, которая торгует на бирже и пишет торговые системы на OCaml.
...
И дело не только в компиляторе — сам язык вырос из ФП, это видно невооружённым глазом.
...
От Haskell — трейты с ассоциированными типами, прямые потомки его type classes.
