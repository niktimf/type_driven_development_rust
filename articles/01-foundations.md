...
Но что допустимо, а что нет, решаем не мы, а домен — мы его только отражаем в коде: разбираемся, какие состояния осмысленны, и переносим правила в типы.
Дальше недопустимое значение просто не собрать, ещё до тестов: бессмыслица вроде «рыночной заявки с лимитной ценой» или «отменённого ордера, всё ещё висящего в стакане» в коде не выражается.
...
Выбор не случаен: здесь идея Мински и родилась. Инвариантов тут много, а ошибки стоят денег.
Сами же приёмы, шаблоны и идеи применимы в любом домене.
